...
const tableColumns = [
  ...
  { title: '品牌', dataIndex: 'brand_std', width: 110, fixed: 'left' as const },
  { title: '机型', dataIndex: 'model_std', width: 130 },
  { title: '宝贝名称', dataIndex: 'item_name', ellipsis: true, width: 280 },
  { title: '店铺', dataIndex: 'shop_name', ellipsis: true, width: 200 },
  { title: '销量', dataIndex: 'sales_qty', width: 80, sorter: true },
  {
        ...
        <Row gutter={12} style={{ marginBottom: 16 }}>
          <Col span={5}>
            <Select
              ...
              allowClear
              style={{ width: '100%' }}
              onChange={v => updateFilter('file_id', v)}
            >
          ...
          <Col span={5}>
            <Input
              placeholder="搜索品牌"
              allowClear
              onChange={e => updateFilter('brand_std', e.target.value)}
            />
          </Col>
        </Row>
